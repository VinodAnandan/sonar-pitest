...
@Properties({
  ...
  @Property(key = MUTATE_STATIC_INITIALIZERS, defaultValue = "false",
    name = "Mutate static initializers", description = "Whether or not to create mutations in static initializers. Defaults to false.", global = true,
    project = true),
  ...
  @Property(key = FAIL_WHEN_NO_MUTATIONS, defaultValue = "true",
    name = "Throw error if no mutations found", description = "Whether to throw error when no mutations found. Defaults to true.", global = true,
    project = true),
